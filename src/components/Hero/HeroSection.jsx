...
import heroImg from "../../assets/forest.jpg"; // your second image
...
const HeroSection = () => {
  return (
    <section className="relative w-full h-[85vh] md:h-screen overflow-hidden">
      ...
      {/* Overlay (dark gradient like luxury site) */}
      <div className="absolute inset-0 bg-black/40 md:bg-gradient-to-r md:from-black/60 md:via-black/30 md:to-transparent"></div>

      {/* Content */}
      <div className="relative z-10 flex items-center h-full px-6 md:px-16 lg:px-24">
        
        <div className="max-w-xl text-white ml-auto md:ml-auto md:text-left text-center">
          ...
          <p className="mt-4 text-sm sm:text-base md:text-lg lg:text-xl text-gray-200">
            Authentic Ayurvedic Detox and Rejuvenation
          </p>

          {/* Button (optional but improves UX) */}
          {/* <div className="mt-6">
            <button className="px-6 py-3 bg-white text-black text-sm md:text-base font-medium rounded-full hover:bg-gray-200 transition">
              Explore Programs
            </button>
          </div> */}
        </div>
      ...
      {/* Award Badge (top-right like screenshot) */}
      {/* <div className="absolute top-6 right-6 md:top-10 md:right-10 z-20">
        <div className="w-16 h-16 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center text-black text-[10px] md:text-xs font-semibold text-center p-2 shadow-lg">
          2026 <br /> WINNER
        </div>
      </div> */}
    </section>
